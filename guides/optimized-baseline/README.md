...
| Metric            | k8s service (RR) | llm-d (vLLM) | llm-d (SGLang) | Δ% (vLLM vs k8s) |
| :---------------- | :--------------- | :----------- | :------------- | :--------------- |
| Output tokens/sec | 5,722            | 13,163       | 13,694         | +130.0%          |
| Requests/sec      | 35.87            | 36.38        | 36.05          | +1.4%            |
| TTFT mean (s)     | 58.10            | 0.156        | 0.285          | −99.73%          |
| TTFT p90 (s)      | 107.43           | 0.206        | 0.188          | −99.81%          |
| ITL mean (ms)     | 44.0             | 47.0         | 41.3           | +6.8%            |
...
| Rate | k8s Output | vLLM Output | SGLang Output | vLLM TTFT mean | SGLang TTFT mean | vLLM TTFT p90 | SGLang TTFT p90 |
| ---: | ---------: | ----------: | ------------: | -------------: | ---------------: | ------------: | --------------: |
|  3   | 1,797      | 1,777       | 1,540         | 0.133          | 0.132            | 0.162         | 0.157           |
| 10   | 4,215      | 5,066       | 4,927         | 0.125          | 0.118            | 0.172         | 0.163           |
| 15   | 5,381      | 7,053       | 7,204         | 0.122          | 0.115            | 0.187         | 0.174           |
| 20   | 6,205      | 11,688      | 11,336        | 0.174          | 0.169            | 0.283         | 0.252           |
| 22   | 5,517      | 12,436      | 11,933        | 0.116          | 0.112            | 0.148         | 0.151           |
| 25   | 5,965      | 12,501      | 12,763        | 0.116          | 0.116            | 0.146         | 0.152           |
| 30   | 5,702      | 13,862      | 13,552        | 0.117          | 0.113            | 0.148         | 0.147           |
| 35   | 5,890      | 14,026      | 13,289        | 0.117          | 0.109            | 0.150         | 0.147           |
| 40   | 6,336      | 16,041      | 15,704        | 0.153          | 0.962            | 0.216         | 0.256           |
| 43   | 6,588      | 16,339      | 16,481        | 0.254          | 1.073            | 0.218         | 0.204           |
| 46   | 6,459      | 16,665      | 16,878        | 0.154          | 0.133            | 0.220         | 0.167           |
| 49   | 6,265      | 16,126      | 16,629        | 0.151          | 0.136            | 0.209         | 0.171           |
| 52   | 6,303      | 16,474      | 16,995        | 0.152          | 0.146            | 0.219         | 0.198           |
| 55   | 6,290      | 16,854      | 17,155        | 0.153          | 0.143            | 0.215         | 0.183           |
| 57   | 6,089      | 16,641      | 17,020        | 0.153          | 0.142            | 0.217         | 0.191           |
| 60   | 6,551      | 17,064      | 17,156        | 0.154          | 0.145            | 0.217         | 0.208           |
